    ...
    return(
      <div className="App">
        ...
        <div className="favouriteContainer"> 
          ...
          {store.faveuritrsPictures.map(m=><div className="faves"><img onClick={this.changeClassName} className="favepics" src={m.picture}/><br></br>{m.picDescription}<br></br><button className="deleteFromFave" value={m.picId} onClick={this.deletePhotoFromFaveurites}>delete from faveurites</button></div>)}
       </div>
      </div>
    )
  }
